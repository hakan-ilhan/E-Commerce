  ...
  return (
    <div className="relative flex max-w-[1920px] m-auto  justify-center py-24 bg-lightGrey">
      <div className="flex flex-col gap-10 w-[75%] pb-12">
        <div className="w-[50%] flex flex-col gap-3 m-auto md:w-full">
        ...
        <div className="flex gap-7 m-auto flex-wrap ">
          <div
            className="max-w-[500px] h-[500px] bg-no-repeat bg-cover cursor-pointer m-auto md:w-[323px] md:m-auto"
          ...
          <div
            className="md:m-auto w-[240px] h-[500px] bg-no-repeat bg-cover cursor-pointer md:w-[323px]"
          ...
          <div className="flex flex-col gap-3 md:m-auto">
            <div
              className="w-[240px] h-[242px] bg-no-repeat bg-cover cursor-pointer m-auto md:w-[323px]"
              style={{ backgroundImage: `url(${Card3})` }}
            >
              <NavLink to="/" className="inline-block w-[240px] h-[242px]  ">
                <div className="bg-white w-[170px]  py-3 px-6 font-mont font-bold tracking-[0.1px] text-categoryColor flex  ml-4 mt-[70%] text-center md:px-3 md:w-[125px] md:mt-[75%]">
                  ACCESSORIES
                </div>
              </NavLink>
            </div>
            ...
            >
              <NavLink to="/" className="inline-blockw-[240px] h-[242px] ">
                <div className="bg-white w-[120px]  py-3 px-6 font-mont font-bold tracking-[0.1px] text-categoryColor flex  ml-4 mt-[70%]  justify-center md:mt-[60%]">
                  <p>KIDS</p>
                </div>
              </NavLink>
            </div>
